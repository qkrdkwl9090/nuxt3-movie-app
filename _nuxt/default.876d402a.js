...
`;bt(vt);oe.render=ht;var ae={name:"InputText",extends:M,emits:["update:modelValue"],props:{modelValue:null},methods:{onInput(e){this.$emit("update:modelValue",e.target.value)}},computed:{filled(){return this.modelValue!=null&&this.modelValue.toString().length>0}}};const gt=["value"];function yt(e,t,n,r,s,i){return l(),m("input",b({class:["p-inputtext p-component",{"p-filled":i.filled}],value:n.modelValue,onInput:t[0]||(t[0]=(...a)=>i.onInput&&i.onInput(...a))},e.ptm("root")),null,16,gt)}ae.render=yt;const _t={class:"py-4 flex items-center justify-between px-6 xl:px-8"},Ct={class:"flex items-center"},kt=f("i",{class:"pi pi-search text-white"},null,-1),Lt=[kt],xt={class:"flex items-center"},$t={class:"p-2"},Et={key:1},wt=f("h3",{class:"font-bold text-lg"},"Result",-1),St={class:"mt-2"},Tt={key:0},It={key:1,class:"flex gap-8 flex-wrap"},Ft={__name:"Header",setup(e){const t=D(!1),n=D(""),r=D(0),s=z(()=>r.value>0),i=nt(()=>{r.value=window.scrollY},100);_e(()=>{document.addEventListener("scroll",i)}),Ce(()=>{container.removeEventListener("scroll",i)});const a=z(()=>`/v2/list_movies.json?query_term=${n.value}&sort_by=rating&limit=20`),o=async()=>await me(a.value).then(E=>E.data.movies),{data:u,isFetching:c,refetch:F}=fe({queryKey:[a],queryFn:o}),_=()=>{F()};return(E,h)=>{const j=pe,R=J("Skeleton"),B=he;return l(),m(q,null,[f("header",{class:ke(["w-screen | shrink-0 fixed z-10 transition-[background] duration-300",g(s)?"bg-black":"bg-transparent"])},[f("section",_t,[f("div",Ct,[L(j,{class:"mr-6 font-bold text-2xl text-red-600 cursor-pointer",to:"/"},{default:k(()=>[W(" Reelify ")]),_:1})]),f("button",{onClick:h[0]||(h[0]=()=>t.value=!0)},Lt)])],2),L(g(oe),{visible:g(t),"onUpdate:visible":h[3]||(h[3]=v=>H(t)?t.value=v:null),position:"full"},{header:k(()=>[f("section",xt,[L(j,{class:"mr-6 font-bold text-2xl text-red-600 cursor-pointer",to:"/"},{default:k(()=>[W(" Reelify ")]),_:1}),L(g(ae),{type:"text",modelValue:g(n),"onUpdate:modelValue":h[1]||(h[1]=v=>H(n)?n.value=v:null),class:"w-full",onInput:_,placeholder:" Movie Title/IMDb Code, Actor Name/IMDb Code, Director Name/IMDb Code"},null,8,["modelValue"])])]),default:k(()=>{var v;return[f("section",$t,[g(c)?(l(),$(R,{key:0,width:"300"})):(l(),m("div",Et,[wt,f("section",St,[(v=g(u))!=null&&v.length?(l(),m("div",It,[(l(!0),m(q,null,Le(g(u),C=>(l(),$(B,{onClick:h[2]||(h[2]=()=>t.value=!1),key:C.id,id:C.id,src:C.medium_cover_image,title:C.title},null,8,["id","src","title"]))),128))])):(l(),m("p",Tt,"Not found"))])]))])]}),_:1},8,["visible"])],64)}}};var le={name:"ChevronUpIcon",extends:Q};const jt=f("path",{d:"M12.2097 10.4113C12.1057 10.4118 12.0027 10.3915 11.9067 10.3516C11.8107 10.3118 11.7237 10.2532 11.6506 10.1792L6.93602 5.46461L2.22139 10.1476C2.07272 10.244 1.89599 10.2877 1.71953 10.2717C1.54307 10.2556 1.3771 10.1808 1.24822 10.0593C1.11933 9.93766 1.035 9.77633 1.00874 9.6011C0.982477 9.42587 1.0158 9.2469 1.10338 9.09287L6.37701 3.81923C6.52533 3.6711 6.72639 3.58789 6.93602 3.58789C7.14565 3.58789 7.3467 3.6711 7.49502 3.81923L12.7687 9.09287C12.9168 9.24119 13 9.44225 13 9.65187C13 9.8615 12.9168 10.0626 12.7687 10.2109C12.616 10.3487 12.4151 10.4207 12.2097 10.4113Z",fill:"currentColor"},null,-1),Bt=[jt];function At(e,t,n,r,s,i){return l(),m("svg",b({width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg"},e.pti()),Bt,16)}le.render=At;var ce={name:"ScrollTop",extends:M,scrollListener:null,container:null,props:{target:{type:String,default:"window"},threshold:{type:Number,default:400},icon:{type:String,default:void 0},behavior:{type:String,default:"smooth"}},data(){return{visible:!1}},mounted(){this.target==="window"?this.bindDocumentScrollListener():this.target==="parent"&&this.bindParentScrollListener()},beforeUnmount(){this.target==="window"?this.unbindDocumentScrollListener():this.target==="parent"&&this.unbindParentScrollListener(),this.container&&(S.clear(this.container),this.overlay=null)},methods:{onClick(){(this.target==="window"?window:this.$el.parentElement).scroll({top:0,behavior:this.behavior})},checkVisibility(e){e>this.threshold?this.visible=!0:this.visible=!1},bindParentScrollListener(){this.scrollListener=()=>{this.checkVisibility(this.$el.parentElement.scrollTop)},this.$el.parentElement.addEventListener("scroll",this.scrollListener)},bindDocumentScrollListener(){this.scrollListener=()=>{this.checkVisibility(p.getWindowScrollTop())},window.addEventListener("scroll",this.scrollListener)},unbindParentScrollListener(){this.scrollListener&&(this.$el.parentElement.removeEventListener("scroll",this.scrollListener),this.scrollListener=null)},unbindDocumentScrollListener(){this.scrollListener&&(window.removeEventListener("scroll",this.scrollListener),this.scrollListener=null)},onEnter(e){S.set("overlay",e,this.$primevue.config.zIndex.overlay)},onAfterLeave(e){S.clear(e)},containerRef(e){this.container=e}},computed:{containerClass(){return["p-scrolltop p-link p-component",{"p-scrolltop-sticky":this.target!=="window"}]},scrollTopAriaLabel(){return this.$primevue.config.locale.aria?this.$primevue.config.locale.aria.scrollTop:void 0}},components:{ChevronUpIcon:le}};const Ot=["aria-label"];function Rt(e,t,n,r,s,i){return l(),$(ee,{name:"p-scrolltop",appear:"",onEnter:i.onEnter,onAfterLeave:i.onAfterLeave},{default:k(()=>[s.visible?(l(),m("button",b({key:0,ref:i.containerRef,class:i.containerClass,onClick:t[0]||(t[0]=(...a)=>i.onClick&&i.onClick(...a)),type:"button","aria-label":i.scrollTopAriaLabel},e.ptm("root")),[x(e.$slots,"icon",{},()=>[(l(),$(te(n.icon?"span":"ChevronUpIcon"),b({class:["p-scrolltop-icon",n.icon]},e.ptm("icon")),null,16,["class"]))])],16,Ot)):w("",!0)]),_:3},8,["onEnter","onAfterLeave"])}function Nt(e,t){t===void 0&&(t={});var n=t.insertAt;if(!(!e||typeof document>"u")){var r=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css",n==="top"&&r.firstChild?r.insertBefore(s,r.firstChild):r.appendChild(s),s.styleSheet?s.styleSheet.cssText=e:s.appendChild(document.createTextNode(e))}}var Dt=`
.p-scrolltop {
    position: fixed;
    bottom: 20px;
    right: 20px;
...
`;Nt(Dt);ce.render=Rt;const Vt={class:"main__container overflow-x-hidden shrink-0"},Mt={class:"bg-black"},Pt=xe({__name:"default",setup(e){return(t,n)=>{const r=Ft;return l(),m("div",Vt,[L(r),f("main",Mt,[x(t.$slots,"default",{},void 0,!0)]),L(g(ce),{target:"parent"})])}}});const Ht=ge(Pt,[["__scopeId","data-v-510c0781"]]);export{Ht as default};
