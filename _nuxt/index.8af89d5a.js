import{u as B,a as V,b as H,F as oe,s as ae,c as se}from"./portal.esm.dff515ef.js";import{j as D,H as E,E as s,F as c,G as o,u as r,O as g,R as b,$ as C,a0 as w,Q as k,M as v,a1 as le,a2 as re,a3 as de,N as y,D as h,V as I,K as x,I as O,T as ce,J as S,a4 as M,w as F,r as me}from"./swiper-vue.4f17a82e.js";import{a as ue,s as W,b as Q,Z as $,D as f,U as G,R as pe}from"./entry.7a109ab9.js";const he={class:"h-[43.75rem] overflow-hidden relative"},ge=["src"],fe={class:"absolute bottom-16 left-16"},ye={class:"text-white font-bold text-4xl mb-5"},be={__name:"TopPlayer",props:{movie:Object},setup(e){const t=e,a=B(),l=D(()=>`https://www.youtube.com/embed/${t.movie.yt_trailer_code}?loop=1&playlist=${t.movie.yt_trailer_code}&autoplay=1&mute=1&controls=0&showinfo=0&disablekb=1&fs=1&modestbranding=1`),i=()=>a.show(t.movie.id);return(n,m)=>{const u=E("Button");return s(),c("div",he,[o("iframe",{src:r(l),class:"mt-[-8.75rem]",width:"1920",height:"1080",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"},`\r
    `,8,ge),o("div",fe,[o("p",ye,g(e.movie.title),1),b(u,{class:"w-[6.875rem]",label:"Info",severity:"secondary",onClick:i})])])}}},ve={class:"text-2xl font-bold"},Ce=["onClick"],_e=["src"],xe={class:"mt-2 text-left"},we={__name:"MovieList",props:{movieList:{type:Object,required:!0}},setup(e){const t=B();return(a,l)=>{const i=re,n=de;return s(),c("section",null,[(s(!0),c(C,null,w(e.movieList,(m,u)=>(s(),c("div",{key:u,class:"text-white [&+&]:mt-4"},[o("h3",ve,g(u),1),b(n,{class:"mt-4",slidesPerView:"4",breakpoints:{1024:{slidesPerView:7},640:{slidesPerView:4}},spaceBetween:"30",modules:[r(le)],scrollbar:{hide:!0}},{default:k(()=>[(s(!0),c(C,null,w(m,p=>(s(),v(i,{key:p.id,class:"cursor-pointer min-w-[40px] xl:min-w-[9.375rem]"},{default:k(()=>[o("button",{onClick:()=>r(t).show(p.id)},[o("img",{src:p.medium_cover_image,alt:"",class:"rounded-md w-full"},null,8,_e),o("p",xe,g(p.title),1)],8,Ce)]),_:2},1024))),128))]),_:2},1032,["modules"])]))),128))])}}},ke={},Le={class:"mt-4"},ze={class:"flex gap-[30px]"};function De(e,t){const a=E("Skeleton");return s(),c("section",null,[b(a,{width:"12.5rem",height:"2rem"}),o("div",Le,[o("div",ze,[(s(),c(C,null,w(7,l=>b(a,{key:l,width:"14.5rem",height:"18.75rem",class:"hidden xl:block"})),64)),(s(),c(C,null,w(4,l=>b(a,{key:l,width:"14.5rem",height:"18.75rem",class:"block xl:hidden"})),64))])])])}const Be=ue(ke,[["render",De]]),Ee={key:0,class:"p-10"},Se=o("h4",{class:"text-lg text-white font-bold"},"Suggestions",-1),$e={class:"mt-4 flex flex-wrap gap-12 justify-between text-white cursor-pointer"},Ie=["onClick"],Me=["src","alt"],Ve={class:"mt-2 text-left"},He={__name:"Suggestions",props:["id"],setup(e){const{id:t}=e,a=B(),l=`/v2/movie_suggestions.json?movie_id=${t}`,i=async()=>await H(l).then(({data:u})=>u.movies),{data:n,isSuccess:m}=V({queryKey:[l],queryFn:i});return(u,p)=>r(m)?(s(),c("section",Ee,[Se,o("div",$e,[(s(!0),c(C,null,w(r(n),d=>(s(),c("button",{class:"w-[13.75rem]",key:d.id,onClick:()=>r(a).change(d.id)},[o("img",{class:"rounded-md",src:d.medium_cover_image,alt:d.title},null,8,Me),o("p",Ve,g(d.title),1)],8,Ie))),128))])])):y("",!0)}};var J={name:"Tag",extends:W,props:{value:null,severity:null,rounded:Boolean,icon:String},computed:{containerClass(){return["p-tag p-component",{"p-tag-info":this.severity==="info","p-tag-success":this.severity==="success","p-tag-warning":this.severity==="warning","p-tag-danger":this.severity==="danger","p-tag-rounded":this.rounded}]},iconClass(){return["p-tag-icon",this.icon]}}};function Pe(e,t,a,l,i,n){return s(),c("span",h({class:n.containerClass},e.ptm("root")),[e.$slots.icon?(s(),v(I(e.$slots.icon),h({key:0,class:"p-tag-icon"},e.ptm("icon")),null,16)):a.icon?(s(),c("span",h({key:1,class:n.iconClass},e.ptm("icon")),null,16)):y("",!0),x(e.$slots,"default",{},()=>[o("span",h({class:"p-tag-value"},e.ptm("value")),g(a.value),17)])],16)}function Te(e,t){t===void 0&&(t={});var a=t.insertAt;if(!(!e||typeof document>"u")){var l=document.head||document.getElementsByTagName("head")[0],i=document.createElement("style");i.type="text/css",a==="top"&&l.firstChild?l.insertBefore(i,l.firstChild):l.appendChild(i),i.styleSheet?i.styleSheet.cssText=e:i.appendChild(document.createTextNode(e))}}var je=`
.p-tag {
    display: inline-flex;
    align-items: center;
...
`;Qe(Je);ie.render=We;const et=["src"],tt={class:"absolute top-6 right-6 bg-black w-8 h-8 rounded-full hover:bg-gray-500 flex items-center justify-center"},it={class:"p-10 text-white flex justify-between gap-8"},nt={class:"w-3/4"},ot={class:"font-bold text-lg"},at={class:"text-gray-500"},st={class:"mt-4"},lt={class:"mt-4 flex gap-2"},rt={class:"mt-4 grid grid-cols-[6.25rem_1fr] text-gray-400 gap-1"},dt=o("p",null,"Runtime",-1),ct=o("p",null,"Language",-1),mt=o("p",null,"Rating",-1),ut=o("p",null,"Likes",-1),pt=o("i",{class:"pi pi-heart mr-2",style:{"font-size":"0.8125rem"}},null,-1),ht=["src"],gt={class:"mt-4 flex flex-col gap-4"},ft={__name:"MovieDetail",setup(e){const t=B(),a=D(()=>`/v2/movie_details.json?movie_id=${t.id}`),l=async()=>await H(a.value).then(({data:d})=>d.movie);D(()=>t.visible?i:{});const{data:i,isLoading:n,isRefetching:m,refetch:u}=V({queryKey:[a.value],queryFn:l,enabled:t.visible});F(()=>t.visible,d=>{d&&u()}),F(()=>t.id,d=>{if(!d)return;u();const _=document.querySelector(".p-dialog-content");_&&_.scroll(0,0)});const p=D(()=>`https://www.youtube.com/embed/${i==null?void 0:i.value.yt_trailer_code}?controls=0&showinfo=0&disablekb=1&fs=1&modestbranding=1`);return(d,_)=>{const L=E("Skeleton"),ne=He;return s(),v(r(ie),{visible:r(t).visible,modal:"",draggable:!1,closable:!1,closeOnEscape:"",header:"Header",class:"relative",style:{width:"50vw"}},{header:k(()=>{var z;return[(z=r(i))!=null&&z.yt_trailer_code&&!r(m)?(s(),c("iframe",{key:0,src:r(p),class:"w-full h-[25rem] rounded-tl-md rounded-tr-md",frameborder:"0",allow:"accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"},`\r
      `,8,et)):y("",!0),o("button",tt,[o("i",{class:"pi pi-times cursor-pointer text-white",onClick:_[0]||(_[0]=()=>r(t).close())})])]}),default:k(()=>{var z,P,T,j,R,K,Z,q,A,N,X;return[o("section",it,[!r(n)&&!r(m)?(s(),c(C,{key:0},[o("div",nt,[o("h3",ot,[M(g((z=r(i))==null?void 0:z.title)+" ",1),o("span",at,g(` (${(P=r(i))==null?void 0:P.year})`),1)]),o("p",st,g((T=r(i))==null?void 0:T.description_full),1),o("div",lt,[(s(!0),c(C,null,w((j=r(i))==null?void 0:j.genres,Y=>(s(),v(r(J),{key:Y,value:Y},null,8,["value"]))),128))]),o("div",rt,[dt,o("p",null,g((R=r(i))==null?void 0:R.runtime)+" Minute",1),ct,o("p",null,g((K=r(i))==null?void 0:K.language.toUpperCase()),1),mt,o("p",null,g((Z=r(i))==null?void 0:Z.rating)+" / 10",1),ut,o("div",null,[pt,M(g((q=r(i))==null?void 0:q.like_count),1)])])]),o("img",{class:"rounded-md h-min w-1/4",src:(A=r(i))==null?void 0:A.medium_cover_image},null,8,ht)],64)):(s(),c(C,{key:1},[o("section",null,[b(L,{width:"18.75rem"}),o("div",gt,[b(L,{width:"9.375rem"}),b(L,{width:"9.375rem"}),b(L,{width:"9.375rem"})])]),b(L,{width:"12.5rem",height:"18.75rem"})],64))]),(N=r(i))!=null&&N.id&&!r(m)?(s(),v(ne,{key:0,id:(X=r(i))==null?void 0:X.id},null,8,["id"])):y("",!0)]}),_:1},8,["visible"])}}},yt={class:"pt-16 pb-16 px-16"},U="/v2/list_movies.json?minimum_rating=8.5&sort_by=rating&limit=50",_t={__name:"index",setup(e){const t=me({}),a=async()=>await H(U).then(n=>{let m={};return n.data.movies.forEach(p=>{p.genres.forEach(d=>{m[d]?m[d]++:m[d]=1})}),Object.keys(m).filter(p=>m[p]>=6).forEach(p=>{t[p]=n.data.movies.filter(d=>d.genres.includes(p))}),n.data.movies}),{data:l,isSuccess:i}=V({queryKey:[U],queryFn:a});return(n,m)=>{const u=be,p=we,d=Be,_=ft;return s(),c("section",null,[r(i)?(s(),v(u,{key:0,movie:r(l)[0]},null,8,["movie"])):y("",!0),o("section",yt,[r(i)?(s(),v(p,{key:0,movieList:r(t)},null,8,["movieList"])):(s(),v(d,{key:1}))]),b(_)])}}};export{_t as default};
