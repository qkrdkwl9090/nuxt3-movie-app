...
`;Et(It);se.render=Tt;const $t={class:"main__container overflow-x-hidden shrink-0"},jt={class:"bg-black"},Bt={__name:"default",setup(e){return(t,n)=>{const s=Ct;return a(),u("div",$t,[C(s),c("main",jt,[I(t.$slots,"default",{},void 0,!0)]),C(b(se),{target:"parent"})])}}},Vt=ve(Bt,[["__scopeId","data-v-b3319d6e"]]);export{Vt as default};
